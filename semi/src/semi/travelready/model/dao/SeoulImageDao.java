...
public class SeoulImageDao {
	...
	public SeoulImageFile imageDown(Connection conn, int imageNo) {
		PreparedStatement pstmt=null;
		ResultSet rset=null;
		SeoulImageFile sif=null;
		String query="select * from SeoulImage where imageno=?";
	...
	public ArrayList<SeoulImageFile> getSearchCurrentPage(Connection conn, int currentPage, int recordCountPerPage,
			String search) {
		PreparedStatement pstmt=null;
		ResultSet rset=null;
		...
		String query="select * from" +
				"(select seoulimage.*,row_number() over(order by imageno desc)as num from seoulimage where title like ?)" + 
				"where num between ? and ?";
	...
	public SeoulImagePageData getSearchPageNavi(Connection conn, int currentPage, int recordCountPerPage,
		...
		String query="select count(*)as totalCount from seoulimage where title like ?";
