...
/**
 * Servlet implementation class EnjoyCommentDeleteServlet
 */
@WebServlet(name = "EnjoyCommentDelete", urlPatterns = { "/enjoyCommentDelete" })
public class EnjoyCommentDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EnjoyCommentDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new EnjoyService().deleteReview(commentNo);
