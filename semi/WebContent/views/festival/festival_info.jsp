<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="semi.festival.model.vo.*"%>
<%
...
.font {
	color: white;
	text-shadow: 1px -1px 1px rgb(233, 231, 109), -1px 2px 2px
		rgb(137, 31, 199);
	height: 60px;
	margin-bottom: 10px;
		...
		<div class="container">
			<div class="container-fulid">
				<div class="head" style="text-align: center">
					<p class="font"><%=f.getFestivalTitle()%></p>
				</div>
						...
						<div class="panel-body">
							...
							<table style="height: 100%; width: 100%;">
								...
								<tr>
									<td>주소</td>
									<td>
										<!-- 03131 서울 종로구 삼일대로 464(윤현궁) --> <%=f.getFestivalAddr()%>
									</td>
								</tr>
								<tr>
									<td>전화번호</td>
									<td>
										<!-- 02-766-9090 --> <%=f.getFestivalTell()%>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										...
										href="<%=f.getFestivalSite()%>">웹사이트 보기</a>
									</td>
								</tr>
								<tr>
									<td>이용시간</td>
									<td>
										<!-- 11 ~ 3월 09:00 ~ 18:00
									<br>
										4 ~ 10월 09:00 ~ 19:00 --> <%=f.getFestivalPeriod()%>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<!-- 접근가능
										<br>장애인화장실 --> <%=f.getFestivalUtility()%>
									</td>
								</tr>
								<tr>
									<td>규모</td>
								...
								<tr>
									...
									<td>
										...
										<br> 인기 드라마 궁의 촬영 장소로 사용되기도 했다. --> <%=f.getFestivalNotice()%>
									</td>
								</tr>
								<tr>
									<td>이용요금</td>
									<td><%=f.getFestivalPayment()%></td>
								</tr>
								<tr>
									<td>이용시설안내</td>
									<td>
										...
										<br> - 궁중의상체험
										<br> - 대원군행차체험 --> <%=f.getFestivalUtility()%>
									</td>
								</tr>
							</table>
				...
				<div class="panel panel-danger">
					...
					<div id="collapseFour" class="panel-collapse collapse">
						<div class="panel-body">Lorem ipsum dolor sit amet,
							...
							tincidunt lacinia. Aliquam posuere pharetra auctor. Pellentesque
							et eleifend nibh, a bibendum lacus. Pellentesque sit amet
							dignissim mauris. Suspendisse a erat congue nunc auctor
							malesuada. Mauris ultricies magna quis neque egestas, eu vehicula
							sapien luctus. Aenean id condimentum mauris. Integer urna enim,
							vehicula non nunc non, feugiat imperdiet eros. Morbi vitae est at
							erat tristique facilisis. Mauris pulvinar vel arcu vel ultrices.
							Mauris a nisi sit amet urna elementum semper. Etiam dignissim
							pharetra mauris. Donec rhoncus nisl sem, ut ultrices odio
							porttitor sed. Donec consequat facilisis velit. Cras feugiat
							tincidunt fermentum. Duis interdum nec quam id eleifend.</div>
					</div>
				</div>
			</div>
		</div>
