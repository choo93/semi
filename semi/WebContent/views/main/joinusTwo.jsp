		...
		<div class="wrapper">
			...
			<div class="step_design">
				...
				<label>
					...
					<input type="text" style="width:190px!important;margin-left:10px!important;" id="user_phone" onchange="phoneCheck();">
					...
					<input type="text" style="width:190px!important;margin-left:-10px!important;" id="user_phone2" onchange="phoneCheck2();">
				...
				<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" style="width:192px;background-color:black;color:white;height:46px;border:none;margin-left:10px;"><br>
