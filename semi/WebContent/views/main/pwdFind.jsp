...
<body>
	<form action="/pwdFind" method="post">
		<p><label><span style="margin-right:10px;font-weight:bold;">아이디</span><input type="text" name="userId" style="width:220px;"></label></p>
		...
		<input type="submit" value="비밀번호 찾기" style="background-color:black;border:none;color:white;width:282px;height:50px;line-height:50px;cursor:pointer;">
	</form>	
</body>
</html>