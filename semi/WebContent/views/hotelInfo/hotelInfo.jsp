	...
	<div style="width: 1200px; height: 1800px;">
		...
		<div id="hotelPhoto">
			<div id="hotelMainPhoto">
				<img class="mySlides" src="/image/bg1.jpg" height="300px"
					width="600px"> <img class="mySlides" src="/image/bg2.jpg"
					height="300px" width="600px"> <img class="mySlides"
					src="/image/bg3.jpg" height="300px" width="600px"> <img
					class="mySlides" src="/image/menu.png" height="300px" width="600px">
			...
			<div id="hotelInfoSubPhoto">
				<div id="hotelSubPhoto1">
					<img class="demo w3-border w3-hover-shadow" src="/image/bg1.jpg"
						height="100%" width="100%" onclick="currentDiv(1)">
				</div>
				<div id="hotelSubPhoto2">
					<img class="demo w3-border w3-hover-shadow" src="/image/bg2.jpg"
						height="100%" width="100%" ; onclick="currentDiv(2)">
				</div>
				<div id="hotelSubPhoto3">
					<img class="demo w3-border w3-hover-shadow" src="/image/bg3.jpg"
						height="100%" width="100%" onclick="currentDiv(3)">
				</div>
				<div id="hotelSubPhoto4">
					<img class="demo w3-border w3-hover-shadow" src="/image/menu.png"
						height="100%" width="100%" onclick="currentDiv(4)">
				</div>
				<div id="hotelSubPhoto5">
					<img class="demo w3-border w3-hover-shadow" src="/image/"
		...
		<div id="hotelName" style="border-top: 3px solid black;">호텔이름 :  KH정보교육원</div>
		...
		<div id="hotelTotalExplain"
			...
			<hr>
			<div style="width: 100%; height: 90%;">서울 중심에 자리한 럭셔리 호텔인 서울 신라
		...
		<div id="hotelPriceExplain"
			style="width: 100%; height: 10%; display: none;">
			<hr>
			<div style="height: 100%; width: 100%;">호텔 가격(방마다) 싱글룸 : 15만원
				더블룸 : 17만원 패밀리룸 : 19만원 스텐다드룸 : 16만원</div>
		</div>
		...
		<div id="hotelMapInfo" style="width: 100%; height:; display: none;">
			<hr>
